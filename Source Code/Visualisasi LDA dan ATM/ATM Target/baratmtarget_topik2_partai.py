...
app.layout = html.Div([
        ...
        html.Div([
            html.Pre(children= "Visualisasi Motivasi Partai Pendukung dengan ATM | Topik 2 Pergerakan Nasional",
        ...
        html.Div([
            ...
            dcc.RadioItems(
                id='xaxis_raditem',
                options=[
                         {'label': 'Kategori: Pergerakan Nasional', 'value': 'Kategori Topik 2'},
                         {'label': 'Detail Partai', 'value': 'Detail Partai 2'},
                ],
                value='Detail Partai 2',
        ...
        html.Div([
            ...
            dcc.RadioItems(
               id='yaxis_raditem',
                options=[
                         {'label': 'Probabilitas', 'value': 'Probabilitas Topik 2'}
                ],
                value='Probabilitas Topik 2',
                style={"width": "50%", 'font-family':'Arial'}
            ),
        ]),
