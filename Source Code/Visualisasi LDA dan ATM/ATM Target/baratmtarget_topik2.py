...
df = pd.read_csv("visualisasi_atm_target.csv")
...
app.layout = html.Div([
        ...
        html.Div([
            html.Pre(children= "Visualisasi Target dengan ATM | Topik 2 Kesejahteraan Rakyat",
        ...
        html.Div([
            ...
            dcc.RadioItems(
                ...
                options=[
                         ...
                         {'label': 'Detail Kata', 'value': 'Detail Topik 2'},
                ],
                value='Detail Kata',
