...
app.layout = html.Div([
        ...
        html.Div([
            html.Pre(children= "Visualisasi Target dengan LDA | Topik 3 Aspirasi Masyarakat",
        ...
        html.Div([
            ...
            dcc.RadioItems(
                id='xaxis_raditem',
                options=[
                         {'label': 'Kategori: Aspirasi Masyarakat', 'value': 'Kategori Topik 3'},
                         {'label': 'Detail Kata', 'value': 'Detail Topik 3'},
                ],
                value='Detail Kata',
        ...
        html.Div([
           html.Br(),
            ...
            dcc.RadioItems(
               id='yaxis_raditem',
                options=[
                         {'label': 'Probabilitas', 'value': 'Probabilitas Topik 3'}
                ],
                value='Probabilitas',
                style={"width": "50%", 'font-family':'Arial'}
            ),
