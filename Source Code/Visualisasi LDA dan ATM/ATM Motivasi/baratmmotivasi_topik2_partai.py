...
df = pd.read_csv("visualisasi_atm_target_partai.csv")
...
app.layout = html.Div([
        ...
        html.Div([
            html.Pre(children= "Visualisasi Target Partai Pendukung dengan ATM | Topik 2 Kesejahteraan Rakyat",
        ...
        html.Div([
            ...
            dcc.RadioItems(
                id='xaxis_raditem',
                options=[
                         {'label': 'Kategori: Kesejahteraan Rakyat', 'value': 'Kategori Topik 2'},
