...
app.layout = html.Div([
        ...
        html.Div([
            html.Pre(children= "Visualisasi Motivasi Partai Pendukung dengan ATM",
        ...
        html.Div([
            ...
            dcc.RadioItems(
                id='xaxis_raditem',
                options=[
                         {'label': 'Kategori Motivasi', 'value': 'Kategori Motivasi'},
                         {'label': 'Detail Partai', 'value': 'Detail Partai'},
                ],
                value='Detail Partai',
