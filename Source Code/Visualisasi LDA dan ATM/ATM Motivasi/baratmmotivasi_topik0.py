...
df = pd.read_csv("visualisasi_atm_motivasi.csv")
...
app.layout = html.Div([
        ...
        html.Div([
            html.Pre(children= "Visualisasi Motivasi dengan ATM | Topik 0 Peran Anggota Legislatif",
        ...
        html.Div([
            ...
            dcc.RadioItems(
                ...
                options=[
                         ...
                         {'label': 'Detail Kata', 'value': 'Detail Topik 0'},
                ],
