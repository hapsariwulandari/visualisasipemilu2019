...
df = pd.read_csv("visualisasi_atm_motivasi_partai.csv")
...
app.layout = html.Div([
        ...
        html.Div([
            html.Pre(children= "Visualisasi Motivasi Partai Pendukung dengan ATM | Topik 0 Peran Anggota Legislatif",
        ...
        html.Div([
            ...
            dcc.RadioItems(
                id='xaxis_raditem',
                options=[
                         {'label': 'Kategori: Peran Anggota Legislatif', 'value': 'Kategori Topik 0'},
                         {'label': 'Detail Partai', 'value': 'Detail Partai 0'},
                ],
                value='Detail Partai 0',
        ...
        html.Div([
            ...
            dcc.RadioItems(
               id='yaxis_raditem',
                options=[
                         {'label': 'Probabilitas', 'value': 'Probabilitas Topik 0'}
                ],
                value='Probabilitas Topik 0',
                style={"width": "50%", 'font-family':'Arial'}
            ),
        ]),
...
def update_graph(x_axis, y_axis):
    ...
    #barchart.update_traces(texttemplate='y_axis', textposition='outside')
