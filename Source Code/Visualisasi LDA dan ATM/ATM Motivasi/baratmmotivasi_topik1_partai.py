...
app.layout = html.Div([
        ...
        html.Div([
            html.Pre(children= "Visualisasi Target Partai Pendukung dengan ATM | Topik 1 Perekonomian Masyarakat",
        ...
        html.Div([
            ...
            dcc.RadioItems(
                id='xaxis_raditem',
                options=[
                         {'label': 'Kategori: Perekonomian Masyarakat', 'value': 'Kategori Topik 1'},
                         {'label': 'Detail Partai', 'value': 'Detail Partai 1'},
                ],
                value='Detail Partai 1',
