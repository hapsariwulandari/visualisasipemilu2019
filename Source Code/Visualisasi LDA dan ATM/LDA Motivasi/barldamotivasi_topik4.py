...
app.layout = html.Div([
        ...
        html.Div([
            html.Pre(children= "Visualisasi Motivasi dengan LDA | Topik 4 Kesejahteraan Masyarakat",
        ...
        html.Div([
            ...
            dcc.RadioItems(
                id='xaxis_raditem',
                options=[
                         {'label': 'Kategori: Kesejahteraan Masyarakat', 'value': 'Kategori Topik 4'},
                         {'label': 'Detail Kata', 'value': 'Detail Topik 4'},
                ],
        ...
        html.Div([
            ...
            dcc.RadioItems(
               id='yaxis_raditem',
                options=[
                         {'label': 'Probabilitas', 'value': 'Probabilitas Topik 4'}
                ],
