...
app.layout = html.Div([
        ...
        html.Div([
            html.Pre(children= "Visualisasi Motivasi dengan LDA | Topik 3 Isu Agama",
        ...
        html.Div([
            ...
            dcc.RadioItems(
                id='xaxis_raditem',
                options=[
                         {'label': 'Kategori: Isu Agama', 'value': 'Kategori Topik 3'},
                         {'label': 'Detail Kata', 'value': 'Detail Topik 3'},
                ],
                value='Detail Topik 3',
